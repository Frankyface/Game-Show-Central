/* ============================================================
   Family Feud — Fast Money timer core (PURE)
   Vendored verbatim from games/jeopardy/js/timer-core.js (spec 03
   §3 asks for the same red-block bar). Only this banner differs.
   ...
   The DOM half (window.FeudTimer) lives in js/feud-timer.js.
   ============================================================ */
