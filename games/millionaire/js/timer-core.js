/* ============================================================
   Millionaire — lifeline timer core (PURE)
   Vendored verbatim from games/jeopardy/js/timer-core.js by way
   of games/family-feud/js/timer-core.js (spec 08 §7 asks for the
   same red-block strip under the Ask the Audience and Phone a
   Friend windows). Only this banner differs.
   ...
   Node (module.exports). The DOM half (window.WwmTimer) lives in
   js/wwm-timer.js.
   ============================================================ */
